...
- Aprendo de otros desarrolladores consultando sus respositorios
### Flujo de trabajo de GIT
Para añadir un fichero a nuestro repositorio remoto de [GitHub](https://guides.github.com/features/mastering-markdown/) tenemos que seguir los siguientes pasos
```
git add fichero
```
```
